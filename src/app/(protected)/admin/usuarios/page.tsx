  ...
  if (!result.ok) {
    return (
      <div className="flex flex-col gap-4">
        <h1 className="text-xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50">Usuarios y roles</h1>
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
          Gestión de usuarios y roles (<code className="text-xs">user_metadata.app_role</code>).
        </p>
      </div>
